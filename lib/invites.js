...
module.exports = {
	...
	getRoles: (invite) => new Promise((resolve, reject) => {
		// TODO: Get role(s) attached to invite.
	}),

	setRoles: (invite, roles) => new Promise((resolve, reject) => {
		// TODO: Attach role(s) to invite);
	})
};
